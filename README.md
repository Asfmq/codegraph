...
| **20+ Languages** | TypeScript, JavaScript, Python, Go, Rust, Java, C#, PHP, Ruby, C, C++, Objective-C, Swift, Kotlin, Dart, Lua, Luau, Svelte, Liquid, Pascal/Delphi, Fortran |
...
| Fortran | `.f90`, `.f95`, `.f03`, `.f08`, `.f`, `.for`, `.ftn` | Full support for free-form Fortran 90+ (modules, derived types, functions, subroutines, `use`/`include` imports, call edges); fixed-form F77 may have partial extraction on comments/continuation lines |
